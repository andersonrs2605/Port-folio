...
document.onmouseover = function (element) {
    ...
    if (element.target.classList.contains('html')) {
        ...
        titleElement.textContent = "QUAIS SERÃO MEUS PRÓX. PASSOS!!!";
        description.textContent = "No atual momento pretendo me aprofundar em um segundo idioma, que será o inglês. Também pretendo começar uma  pós de ADM de banco de dados.";
    }
